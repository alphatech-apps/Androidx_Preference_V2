...
public class PermissionPreference_m_noicon extends Preference {
    ...
    public PermissionPreference_m_noicon(Context context) {
        this(context, null);
    }

    public PermissionPreference_m_noicon(Context context, AttributeSet attrs) {
        super(context, attrs);
        setLayoutResource(R.layout.preference_layout_material_noicon_permission);
