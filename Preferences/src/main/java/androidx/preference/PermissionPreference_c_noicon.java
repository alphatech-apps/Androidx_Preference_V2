...
public class PermissionPreference_c_noicon extends Preference {
    ...
    public PermissionPreference_c_noicon(Context context) {
        this(context, null);
    }

    public PermissionPreference_c_noicon(Context context, AttributeSet attrs) {
        super(context, attrs);
        setLayoutResource(R.layout.preference_layout_compact_noicon_permission);
