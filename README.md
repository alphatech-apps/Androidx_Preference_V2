...
<androidx.preference.PreferenceScreen xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <PermissionPreference
        ...
        android:key="my_custom_pref"
        android:summary="This permission required to run app properly"
        android:title="Notification Permission"
        app:acceptedText="Permission Granted"
        app:allowed="false"
        app:layout="@layout/preference_layout_compact_noicon_permission"
        app:requestText="Allow Permission" />

    <PermissionPreference
        android:icon="@drawable/round_signal_wifi_statusbar_connected_no_internet_4_24"
        android:key="my_custom_pref"
        android:summary="This permission required to run app properly"
        android:title="Storage Permission"
        app:acceptedText="Permission Granted"
        app:allowed="true"
        app:layout="@layout/preference_layout_compact_permission"
        app:requestText="Allow Permission" />
    ...
    <PermissionPreference
        ...
        app:acceptedText="Permission Granted"
        app:allowed="false"
        app:layout="@layout/preference_layout_material_noicon_permission"
        app:requestText="Allow Access" />

    <PermissionPreference
        android:icon="@drawable/round_signal_wifi_statusbar_connected_no_internet_4_24"
        android:key="my_custom_pref"
        android:summary="This permission required to run app properly"
        android:title="Ignore Battery Optimization"
        app:acceptedText="Allowed"
        app:allowed="true"
        app:layout="@layout/preference_layout_material_permission"
        app:requestText="Add to whitelist" />
...
### 0 Permission for all:

![](https://github.com/alphatech-apps/Androidx_Preference_V2/blob/master/Screenshots/5.png)
